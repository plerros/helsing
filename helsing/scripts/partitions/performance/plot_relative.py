...
csv_mean1 = list(np.float64(csv_mean1))
csv_stddev1 = list(np.float64(csv_stddev1))
csv_mean2 = list(np.float64(csv_mean2))
csv_stddev2 = list(np.float64(csv_stddev2))
#csv_distance = list(np.float64(csv_distance))
